...
public class PrincipioConBusquedaThree {
    public static void main(String[] args) {

        Scanner lectura = new Scanner(System.in);
        System.out.println("Escribe el título de la película: ");
        var busqueda = lectura.nextLine().trim(); // trim para eliminar espacios en blanco
        ...
        try {
            ...
            System.out.println("Búsqueda codificada: " + busquedaCodificada); // Ver la codificación en la consola
